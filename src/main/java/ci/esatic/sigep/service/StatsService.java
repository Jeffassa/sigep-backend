...
/**
 * Statistiques INDIVIDUELLES de l'enseignant (consommées par l'app mobile, /api/stats/moi).
 * Le tableau de bord global admin est dans {@link StatistiquesService}.
 * Ici, les heures effectuées sont calculées sur la DURÉE RÉELLE des séances (heureFin - heureDebut).
 */
@Service
