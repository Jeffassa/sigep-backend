...
/**
 * Statistiques GLOBALES du tableau de bord admin (/admin/statistiques) : taux, comparaison de
 * période, heatmap jour×créneau, tendance, répartitions et recommandations. Séparé de
 * {@link StatsService} (stats individuelles de l'enseignant / mobile) pour respecter le SRP.
 */
@Service
...
public class StatistiquesService {
    ...
    @Value("${app.stats.heures-par-seance:2.0}")
